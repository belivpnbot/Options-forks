...
# luci-app-netdata
svn co https://github.com/sirpdboy/sirpdboy-package/tree/main/netdata feeds/luci/applications/luci-app-netdata
svn co https://github.com/sirpdboy/sirpdboy-package/tree/main/netdata feeds/packages/net/netdata
...
# ddnsto插件
git clone https://github.com/linkease/nas-packages-luci package/luci-app-ddnsto
